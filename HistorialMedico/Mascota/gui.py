...
class Frame(tk.Frame):
    ...
    def etiquetasMascota(self):
        ...
        self.entryNombre.config(width=40, font=('ARIAL',12))
        ...
        self.entryNumeroChip.config(width=40, font=('ARIAL',12))
        ...
        self.entryEspecie.config(width=40, font=('ARIAL',12))
        self.entryEspecie.grid(column=1, row=2, padx=10, pady=5, columnspan=2)

        self.svSexo = tk.StringVar()
        self.entrySexo = tk.Entry(self, textvariable=self.svSexo)
        self.entrySexo.config(width=40, font=('ARIAL',12))
        self.entrySexo.grid(column=1, row=3, padx=10, pady=5, columnspan=2)

        self.svTamano = tk.StringVar()
        self.entryTamano = tk.Entry(self, textvariable=self.svTamano)
        self.entryTamano.config(width=40, font=('ARIAL',12))
        self.entryTamano.grid(column=1, row=4, padx=10, pady=5, columnspan=2)

        self.svRaza = tk.StringVar()
        self.entryRaza = tk.Entry(self, textvariable=self.svRaza)
        self.entryRaza.config(width=40, font=('ARIAL',12))
        ...
        self.entryColor.config(width=40, font=('ARIAL',12))
        self.entryColor.grid(column=1, row=6, padx=10, pady=5, columnspan=2)

        self.svEdad = tk.StringVar()
        self.entryEdad = tk.Entry(self, textvariable=self.svEdad)
        self.entryEdad.config(width=40, font=('ARIAL',12))
        ...
        self.entryFechaNacimiento.config(width=40, font=('ARIAL',12))
        ...
        self.entryAntecedentes.config(width=40, font=('ARIAL',12))
        ...
        self.btnGuardar = tk.Button(self, text='Guardar', command=self.GuardarMascota)
    ...
    def GuardarMascota(self):
        mascota = Mascota(
            self.svNombre.get, self.svNumeroChip.get, self.svEspecie.get, self.svSexo.get, self.svTamano.get, 
            self.svRaza.get, self.svColor.get, self.svEdad.get, self.svFechaNacimiento.get,
